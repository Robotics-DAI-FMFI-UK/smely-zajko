...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../nn_lib_2 `pkg-config --cflags opencv` `pkg-config --cflags fann` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

# Subprojects
.build-subprojects:
	cd ../nn_lib_2 && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../nn_lib_2 && ${MAKE}  -f Makefile CONF=Debug clean
