...
${OBJECTDIR}/ContextHistogram.o: ContextHistogram.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/opencv -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContextHistogram.o ContextHistogram.cpp

${OBJECTDIR}/ContextProbableRectangle.o: ContextProbableRectangle.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/opencv -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ContextProbableRectangle.o ContextProbableRectangle.cpp

${OBJECTDIR}/ModKMeans.o: ModKMeans.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/opencv -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModKMeans.o ModKMeans.cpp

${OBJECTDIR}/VisionBaseNew.o: VisionBaseNew.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include -I/usr/include/opencv -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VisionBaseNew.o VisionBaseNew.cpp
