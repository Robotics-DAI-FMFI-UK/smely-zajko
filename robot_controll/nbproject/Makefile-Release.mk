...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/robot_controll

dist/Release/GNU-Linux-x86/robot_controll: ${OBJECTFILES}
...
${OBJECTDIR}/PhoneThread.o: PhoneThread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PhoneThread.o PhoneThread.cpp

${OBJECTDIR}/JoystickThread.o: JoystickThread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/JoystickThread.o JoystickThread.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/robot_controll
