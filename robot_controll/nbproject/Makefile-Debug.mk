...
LDLIBSOPTIONS=-L/usr/lib/x86_64-linux-gnu -L/usr/lib ../nn_lib/dist/Debug/GNU-Linux/libnn_lib.a -lopencv_core -lopencv_highgui -lopencv_ml -lfann -lpthread -lopencv_imgproc -lopencv_legacy `pkg-config --libs yaml-cpp`  
...
${OBJECTDIR}/EvalDireciton.o: EvalDireciton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../rapidxml-1.13 -I/usr/include/opencv -I../nn_lib -I../../fann-2.1.0/src/include `pkg-config --cflags yaml-cpp`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EvalDireciton.o EvalDireciton.cpp
