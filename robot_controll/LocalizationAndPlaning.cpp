...
void LocalizationAndPlaning::calcEllipse(Ll point, double km) {
...
// x = lat y = lon
pair<Ll, Ll> LocalizationAndPlaning::ellipseLineIntersection(Ll p0, Ll p1) {
    Ll re1;
    Ll re2;
...
Ll LocalizationAndPlaning::intersection_of_bearings(Ll p1, double b1, Ll p2,
                                                    double b2) {
...
// "point"
pair<double, Ll>
LocalizationAndPlaning::dist_point_linesegment(Ll point, Ll start, Ll end) {
...
void LocalizationAndPlaning::calcPath(
...
GpsAngles LocalizationAndPlaning::update(Ll gps) {
    ...
    result.map = calc_bearing(
        curPoint, headingPoint); // bearing in degrees to heading point
